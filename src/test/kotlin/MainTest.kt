...
class MainTest {
    ...
    fun `Person is adult when age is 18`() {
        ...
        assertTrue(person.isAdult,
            "Person should be considered an adult at age 18")
    }
    ...
    fun `Person is adult when age is over 18`() {
        ...
        assertTrue(person.isAdult,
            "Person should be considered an adult when age is over 18")
    }
    ...
    fun `Person is not adult when age is under 18`() {
        ...
        assertFalse(person.isAdult,
            "Person should not be considered an adult when age is under 18")
    }
}
